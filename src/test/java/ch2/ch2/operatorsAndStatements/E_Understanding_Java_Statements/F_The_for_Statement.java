...
public class F_The_for_Statement {
    ...
    public void theForStatement_1() {
        ...
        //The local variable i is initialized first to 0. The variable i is only in scope for the duration of the loop and is not available outside the loop once the loop has completed
    ...
    public void theForStatement_3() {
        ...
        //your initialization block, boolean expression, and update statements can include extra variables that may not reference each other. For example,
    ...
    public void theForStatement_5() {
        int x = 0;
        long y = 10;
        //compila porque en el bloque de inicializacion asigna un valor a x pero no la declara
