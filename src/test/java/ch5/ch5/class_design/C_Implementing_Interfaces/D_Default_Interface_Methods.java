...
This example defines two interface methods, one is a normal abstract method and the
...
provide a body, whereas the second default method provides a body. Any class that imple-
ments IsWarmBlooded may rely on the default implementation of getTemperature() or
...
In this example, the first method, eatMeat(), doesn’t compile because it is marked as
...
previous example.
    ...
    public void default_Methods_and_Multiple_Inheritance(){
        /*
...
In this example, Cat inherits the two default methods for getSpeed(), so which does it
...
You can see that having a class that implements or inherits two duplicate default meth-
ods forces the class to implement a new version of the method, or the code will not compile.
