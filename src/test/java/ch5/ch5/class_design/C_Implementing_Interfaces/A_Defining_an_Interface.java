...
tion. In Java, an interface is defined with the interface keyword, analogous to the class
...
example, abstract and public, are assumed. In other words, whether or not you provide
...
It compiles without issue, since interfaces are not required to define any methods. Now
...
instantiated directly. The second example, WalksOnEightLegs, doesn’t compile since inter-
faces may not be marked as final for the same reason that abstract classes cannot be
marked as final.
The fourth and fifth rule about “assumed keywords” might be new to you, but you
should think of these in the same light as the compiler inserting a default no-argument con-
structor or super() statement into your constructor. You may provide these modifiers your-
...
reasons. First, it is marked as final, which cannot be applied to an interface since it con-
fl icts with the assumed abstract keyword. Next, it is marked as private, which conflicts
