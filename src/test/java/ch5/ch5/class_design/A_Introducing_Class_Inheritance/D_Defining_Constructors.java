...
In the fi rst class, Animal, the first statement of the constructor is a call to the parent
constructor defined in java.lang.Object, which takes no arguments. In the second class,
Zebra, the fi rst statement of the first constructor is a call to Animal’s constructor, which
...
Since super() can only be used as the fi rst statement of the constructor, the code will like-
wise not compile.
...
*/
    ...
    /*
    Up to now, we defi ned numerous classes that did not explicitly call the parent construc-
