...
being overridden, check that the access modifi ers, return types, and any exceptions defi ned
...
In this example, both parent and child classes defi ne two methods, hasLegs() and
...
third rule of overriding methods, though, as no new exception is defi ned. In other words, a
...
mean the child class can’t defi ne its own version of the method. It just means, strictly speak-
...
Contrast this fi rst example with the following example, which uses an overridden ver-
sion of isBiped() instead of a hidden version:
class Marsupial {
...
Chapter 4, you can create a method with the final keyword. By doing so, though, you for-
