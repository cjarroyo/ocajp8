...
the final modifi er. If you try to defi ne a class that inherits from a final class, the compiler
...
Because Java allows only one public class per file, we can create two fi les, Animal.java
