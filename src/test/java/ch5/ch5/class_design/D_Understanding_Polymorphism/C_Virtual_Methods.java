...
What makes a virtual method special in Java is that if you call a method on an object that overrides a method, you get the overridden method,
...
As you saw in similar examples in the section “Overriding a Method,” the method getName() is overridden in the child class Peacock.
...
In other words, even though the parent class Ave2 defines its own version of getName() and doesn’t know anything about the Peagiotto class during compile-time, at runtime the
