...
public class C_Working_with_Periods {
    ...
    /* Luckily, Java has a Period class that we can pass in */
    ...
    */
    ...
    public void working_with_Periods_3() {
        /* The following code looks like it is equivalent to the everyYearAndAWeek example, but it’s not. Only the
