package ch3.ch3.core_apis.F_Excersices;

/*
 * Created by: Cristian Arroyo
 * on 11 May 2018 - 6:28 PM
 */
...
public class Excersices {
    ...
    public void Whizlabs_2() {
        ...
        //seran sorteados desde el indice 2 al indice 5, es decir {9, 5, 0, 3}, por lo que quedaria asi {2, 5, 0, 3, 5, 9}
    ...
    public void quince() {
        ...
        //String beans[] = new beans[6]; // debe ser --> String beans[] = new String[6];
        //int[][] types = new int[];
        //int[][] java = new int[][]; // debes inicializar el primero --> int[][] java = new int[4][];
    }
