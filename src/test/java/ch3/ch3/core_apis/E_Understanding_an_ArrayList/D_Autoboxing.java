...
public class D_Autoboxing {
    ...
    public void autoboxing_1(){
        ...
        double first = weights.get(0); // 60.0 //convierte en primitivo automaticamente
    ...
    public void autoboxing_2(){
        ...
        int h = heights.get(0); // we try to unbox that null to an int primitive --> NullPointerException,  Java tries to get the int value of null
    }
