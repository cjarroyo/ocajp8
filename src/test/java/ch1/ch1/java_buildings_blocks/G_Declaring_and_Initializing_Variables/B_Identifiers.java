...
This consistency includes CamelCase. In CamelCase, each word begins with an uppercase letter.
...
If not, you get to mark the answer “does not compile” and skip analyzing everything else in the question.
*/
}
