package ch1.ch1.java_buildings_blocks.G_Declaring_and_Initializing_Variables;
...
/*
We’ve seen some variables already. A variable is a name for a piece of memory that stores data. When you declare a variable, you need to state the variable type along with
giving it a name. For example, the following code declares two variables. One is named zooName and is of type String. The other is named numberAnimals and is of type int.
    String zooName;
    int numberAnimals;
Now that we’ve declared a variable, we can give it a value.
This is called initializing a variable. To initialize a variable, you just type the variable name followed by an equal sign,
...
int i1; int i2;
int i3; i4;
The first statement is legal. It declares two variables without initializing them. The
