...
get called and that it definitely won’t be called twice.
...
The reason is that the program exits before there is any need to run the garbage collec-
tor. While f is eligible for garbage collection, Java has better things to do than take out the
