package ch4.ch4.emthodsAndEncapsulation.B_Working_with_Varargs;
...
public class A_Working_with_Varargs {
    ...
    //public void walk3(int... nums, int start) { } // DOES NOT COMPILE ->  have a vararg parameter in a position that is not the last one

    //public void walk4(int... start, int... nums) { } // DOES NOT COMPILE -> only one
    ...
    public void main2() {
        ...
        walk(1, 2); // 1 --> Java converts this one value to an array of length 1
        walk(1, 2, 3); //2 --> Java converts these two values to an array of length 2
        walk(1, new int[]{4, 5}); //2 --> an array of length 2 directly as nums.
        walk(1, null); // throws a NullPointerException --> it tries to determine the length of null.
    }
